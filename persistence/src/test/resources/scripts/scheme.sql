...
CREATE TABLE MEDS_NOTIFICATION  (
...
CREATE TABLE MEDS_MEDICAL_AID (
  MEDICAL_AID_ID      BIGINT(15)  NOT NULL AUTO_INCREMENT,
  MEDICAL_AID_NAME    BIGINT(50)  NOT NULL,

  PRIMARY KEY (MEDICAL_AID_ID),
  UNIQUE KEY MEDICAL_AID_ID(MEDICAL_AID_ID),
  UNIQUE KEY MEDICAL_AID_NAME(MEDICAL_AID_NAME)
);

CREATE TABLE MEDS_USER_MEDICAL_AID (
  USER_MEDICAL_AID_ID   BIGINT(15)  NOT NULL AUTO_INCREMENT,
  USER_ID               BIGINT(15)  NOT NULL,
  MEDICAL_AID_ID        BIGINT(15)  NOT NULL,

  PRIMARY KEY (USER_MEDICAL_AID_ID),
  UNIQUE KEY USER_MEDICAL_AID_ID(USER_MEDICAL_AID_ID),
  FOREIGN KEY (USER_ID) REFERENCES MEDS_USER (USER_ID),
  FOREIGN KEY (MEDICAL_AID_ID) REFERENCES MEDS_MEDICAL_AID (MEDICAL_AID_ID)
);
...
CREATE TABLE MEDS_PRACTICE_USER (
  PRACTICE_USER_ID     BIGINT(15) NOT NULL AUTO_INCREMENT,
  USER_ID              BIGINT(15) NOT NULL,
  PRACTICE_ID          BIGINT(15) NOT NULL,

  PRIMARY KEY (PRACTICE_USER_ID),
  UNIQUE KEY PRACTICE_USER_ID(PRACTICE_USER_ID),
  FOREIGN KEY (USER_ID) REFERENCES MEDS_USER (USER_ID),
...
CREATE TABLE MEDS_PRACTICE_MEDICAL_AID (
  PRACTICE_MEDICAL_AID_ID   BIGINT(15)  NOT NULL AUTO_INCREMENT,
  PRACTICE_ID               BIGINT(15)  NOT NULL,
  MEDICAL_AID_ID            BIGINT(15)  NOT NULL,

  PRIMARY KEY (PRACTICE_MEDICAL_AID_ID),
  UNIQUE KEY PRACTICE_MEDICAL_AID_ID(PRACTICE_MEDICAL_AID_ID),
  FOREIGN KEY (PRACTICE_ID) REFERENCES MEDS_PRACTICE (PRACTICE_ID),
  FOREIGN KEY (MEDICAL_AID_ID) REFERENCES MEDS_MEDICAL_AID (MEDICAL_AID_ID)
);
...
CREATE TABLE MEDS_DOCTOR_USER (
  DOCTOR_USER_ID     BIGINT(15) NOT NULL AUTO_INCREMENT,
  USER_ID            BIGINT(15) NOT NULL,
